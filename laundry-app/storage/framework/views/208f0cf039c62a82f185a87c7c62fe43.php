...
<aside id="sidebar" class="fixed lg:sticky lg:top-0 inset-y-0 left-0 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 w-64 bg-gradient-to-b from-blue-600 to-blue-700 text-white lg:h-screen flex-shrink-0">
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 px-6 space-y-2 overflow-y-auto">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center space-x-3 px-4 py-3 <?php echo e(Request::routeIs('admin.dashboard') ? 'bg-white bg-opacity-20' : 'hover:bg-white hover:bg-opacity-10'); ?> rounded-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                </svg>
                <span class="font-medium">Dashboard</span>
            </a>
            <a href="<?php echo e(route('admin.layanan.index')); ?>" class="flex items-center space-x-3 px-4 py-3 <?php echo e(Request::routeIs('admin.layanan.*') ? 'bg-white bg-opacity-20' : 'hover:bg-white hover:bg-opacity-10'); ?> rounded-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                </svg>
                <span class="font-medium">Layanan</span>
            </a>
            <a href="<?php echo e(route('admin.pesanan.index')); ?>" class="flex items-center space-x-3 px-4 py-3 <?php echo e(Request::routeIs('admin.pesanan.*') ? 'bg-white bg-opacity-20' : 'hover:bg-white hover:bg-opacity-10'); ?> rounded-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                </svg>
                <span class="font-medium">Pesanan</span>
            </a>
            <a href="<?php echo e(route('admin.pelanggan.index')); ?>" class="flex items-center space-x-3 px-4 py-3 <?php echo e(Request::routeIs('admin.pelanggan.*') ? 'bg-white bg-opacity-20' : 'hover:bg-white hover:bg-opacity-10'); ?> rounded-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                </svg>
                <span class="font-medium">Pelanggan</span>
            </a>
            <a href="<?php echo e(route('admin.laporan.index')); ?>" class="flex items-center space-x-3 px-4 py-3 <?php echo e(Request::routeIs('admin.pembayaran.*') ? 'bg-white bg-opacity-20' : 'hover:bg-white hover:bg-opacity-10'); ?> rounded-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
</script><?php /**PATH C:\laragon\www\project-kik-afnan482\laundry-app\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>