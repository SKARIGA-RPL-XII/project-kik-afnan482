    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50 border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="px-4 py-2 rounded-lg bg-blue-600 text-white font-medium">
                        <i class="fas fa-home mr-2"></i>Dashboard
                    </a>
                    <a href="<?php echo e(route('user.pemesanan.index')); ?>" class="px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100 font-medium transition">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative">
                        ...
                        <div id="userDropdown" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border py-2 z-50">
                            ...
                            <div class="py-2">
                                <a href="<?php echo e(route('user.profile')); ?>" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 transition">
        ...
        <div id="mobileMenu" class="hidden md:hidden border-t bg-white">
            <div class="px-4 py-3 space-y-1">
                <a href="<?php echo e(route('user.dashboard')); ?>" class="block px-4 py-2 rounded-lg bg-blue-50 text-blue-700 font-medium">
                    <i class="fas fa-home mr-2"></i>Dashboard
                </a>
                <a href="<?php echo e(route('user.pemesanan.index')); ?>" class="block px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-50 font-medium transition">
                    <i class="fas fa-plus-circle mr-2"></i>Pesan Laundry
                </a>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div class="bg-white border rounded-xl p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-1">Selamat Datang, <?php echo e(auth()->user()->name); ?>! 👋</h2>
            ...
            <div class="bg-white rounded-xl border p-5 hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($totalOrders ?? 0); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl border p-5 hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($processingOrders ?? 0); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl border p-5 hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($readyOrders ?? 0); ?></p>
                    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            <a href="<?php echo e(route('user.pemesanan.index')); ?>" class="bg-white rounded-xl border p-5 hover:shadow-md transition group">
        ...
        <div class="bg-white rounded-xl border p-6 mb-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold"><?php echo e($activeOrders->count() ?? 0); ?> Pesanan</span>
            </div>
            <div class="space-y-4">
                <?php if(isset($activeOrders) && $activeOrders->count() > 0): ?>
                    <?php $__currentLoopData = $activeOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border rounded-xl p-5 hover:shadow-md hover:border-blue-300 transition">
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <p class="font-bold text-lg text-gray-800"><?php echo e($order->invoice); ?></p>
                                    <p class="text-sm text-gray-500 mt-1"><?php echo e($order->created_at->format('d M Y, H:i')); ?></p>
                                </div>
                                <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($order->status == 'pending' ? 'bg-yellow-100 text-yellow-800' : 
                                    ($order->status == 'proses' ? 'bg-blue-100 text-blue-800' : 
                                    ($order->status == 'selesai' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'))); ?>">
                                    <?php if($order->status == 'pending'): ?> Menunggu Konfirmasi
                                    <?php elseif($order->status == 'proses'): ?> Sedang Diproses
                                    <?php elseif($order->status == 'selesai'): ?> Siap Diambil
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm mb-4">
                                <div class="bg-gray-50 rounded-lg p-3 border">
                                    ...
                                    <p class="font-semibold text-gray-800">
                                        <?php if($order->service_type == 'cuci_kering'): ?> Cuci Kering
                                        <?php elseif($order->service_type == 'cuci_setrika'): ?> Cuci & Setrika
                                        <?php elseif($order->service_type == 'setrika_saja'): ?> Setrika Saja
                                        <?php else: ?> <?php echo e($order->service_type); ?>
                                ...
                                <div class="bg-gray-50 rounded-lg p-3 border">
                                    ...
                                    <p class="font-semibold text-gray-800"><?php echo e(number_format($order->weight, 1)); ?> kg</p>
                                </div>
                            </div>
                            <div class="flex justify-between items-center pt-4 border-t">
                                <div>
                                    <p class="text-xs text-gray-500 mb-1">Total Pembayaran</p>
                                    <p class="font-bold text-xl text-blue-600">Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></p>
                                </div>
                ...
                <?php else: ?>
                    <div class="text-center py-16">
                        ...
                        <a href="<?php echo e(route('user.pemesanan.index')); ?>" class="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
        ...
        <div id="riwayat" class="bg-white rounded-xl border p-6">
            ...
            <div class="space-y-4">
                <?php if(isset($orderHistory) && $orderHistory->count() > 0): ?>
                        ...
                        <div class="border rounded-xl p-5 hover:shadow-md hover:border-purple-300 transition bg-gray-50">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm mb-4">
                                ...
                                <div class="bg-white rounded-lg p-3 border">
                                    ...
                                    <p class="font-semibold text-blue-600">Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></p>
                                </div>
                            </div>
                            <button onclick="viewDetail(<?php echo e($order->id); ?>)" class="text-blue-600 hover:text-blue-800 text-sm font-semibold flex items-center">
...
</html><?php /**PATH C:\laragon\www\project-kik-afnan482\laundry-app\resources\views/user/dashboard.blade.php ENDPATH**/ ?>