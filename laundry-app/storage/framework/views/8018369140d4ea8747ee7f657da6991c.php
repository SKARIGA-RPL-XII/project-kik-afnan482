...
<body class="bg-gradient-to-br from-blue-50 to-gray-100 min-h-screen">
    ...
    <!-- Modal Add -->
    <div id="addModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4" data-modal-type="add">
    ...
    <!-- Modal View -->
    <div id="viewModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4" data-modal-type="view">
    ...
    <!-- Modal Edit -->
    <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4" data-modal-type="edit">
        <div class="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto no-scrollbar">
            <div class="sticky top-0 bg-blue-600 text-white px-6 py-4 flex justify-between items-center rounded-t-xl">
    ...
    <!-- Modal Delete -->
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4" data-modal-type="delete">
    ...
    <div id="riwayatModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4" data-modal-type="riwayat">
...
</html><?php /**PATH C:\laragon\www\laundry-app\resources\views/admin/pelanggan/index.blade.php ENDPATH**/ ?>