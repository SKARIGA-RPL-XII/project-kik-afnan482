    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50 border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    <a href="{{ route('user.dashboard') }}" class="px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100 font-medium transition">
                        <i class="fas fa-home mr-2"></i>Dashboard
                    </a>
                    <a href="{{ route('user.pemesanan.index') }}" class="px-4 py-2 rounded-lg bg-blue-600 text-white font-medium">
        ...
        <div id="mobileMenu" class="hidden md:hidden border-t bg-white">
            <div class="px-4 py-3 space-y-1">
                <a href="{{ route('user.dashboard') }}" class="block px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-50 font-medium transition">
                    <i class="fas fa-home mr-2"></i>Dashboard
                </a>
                <a href="{{ route('user.pemesanan.index') }}" class="block px-4 py-2 rounded-lg bg-blue-50 text-blue-700 font-medium">
                    <i class="fas fa-plus-circle mr-2"></i>Pesan Laundry
                </a>
                <a href="{{ route('user.riwayat.index') }}" class="block px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-50 font-medium transition">
                    <i class="fas fa-history mr-2"></i>Riwayat
                </a>
    ...
    <main class="max-w-7xl mx-auto px-4 py-6 sm:py-8">
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-4">
                <form id="orderForm" data-store-url="{{ route('user.pemesanan.store') }}">
                    <!-- Pilih Layanan -->
                            ...
                            <div class="service-option bg-white border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-blue-600 transition"
                                ...
                                <div class="flex justify-between items-start mb-3">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="font-semibold text-gray-800">{{ $layanan->nama_layanan }}</h3>
                                    </div>
                                ...
                                <div class="mb-2">
                                    <p class="text-blue-600 font-bold text-xl">Rp {{ number_format($layanan->tarif, 0, ',', '.') }}</p>
                                    <p class="text-xs text-gray-500">per {{ $layanan->satuan }}</p>
                                </div>
                                @if($layanan->deskripsi)
                                <p class="text-sm text-gray-600">{{ Str::limit($layanan->deskripsi, 50) }}</p>
                                @endif
                            </div>
                            @empty
    ...
    <div id="successModal" class="bg-black/50">
        <div class="modal-content bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
            ...
            <div class="p-6">
                ...
                <button id="closeModal" data-dashboard-url="{{ route('user.dashboard') }}" 
