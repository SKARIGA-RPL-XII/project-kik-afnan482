                    ...
                    <form action="{{ route('register') }}" method="POST" id="registerForm" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" id="name" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus @error('name') input-error @enderror" placeholder="Masukkan nama lengkap" value="{{ old('name') }}" required>
                            </div>
                            @error('name')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" id="email" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus @error('email') input-error @enderror" placeholder="email@example.com" value="{{ old('email') }}" required>
                            </div>
                            @error('email')
                                <p class="error-message">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="phone" id="phone" oninput="this.value=this.value.replace(/[^0-9]/g,'')" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus @error('phone') input-error @enderror" placeholder="08xxxxxxxxxx" value="{{ old('phone') }}">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password" id="password" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus @error('password') input-error @enderror" placeholder="Minimal 8 karakter" required>
                            </div>
                            @error('password')
                                <p class="error-message">{{ $message }}</p>
                            @enderror
