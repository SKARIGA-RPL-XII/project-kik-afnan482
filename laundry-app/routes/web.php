...
use App\Http\Controllers\Admin\LaporanController; // <--- TAMBAHAN: Import Controller Laporan
...
Route::middleware(['auth', 'role:admin'])
    ...
    ->group(function () {
        ...
        Route::get('/pelanggan/{id}/riwayat', [PelangganController::class, 'getRiwayatPesanan'])->name('pelanggan.riwayat');
        ...
        /* Laporan (BARU) */
        // Route ini akan menjadi: admin.laporan.index
