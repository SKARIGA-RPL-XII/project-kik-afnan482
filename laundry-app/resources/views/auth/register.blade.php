...
<head>
    ...
    <style>
        ...
        .input-focus:focus { transform: translateY(-1px); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); }
        ...
        .error-message { color: #ef4444; font-size: 0.72rem; margin-top: 0.2rem; }
        ...
        .form-scroll-area::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 4px; }
        ...
        .location-badge {
            ...
            border-radius: 0.375rem; padding: 0.4rem 0.65rem;
            font-size: 0.72rem; color: #1d4ed8;
        }
    </style>
</head>
<body class="bg-gradient-to-br from-blue-50 via-white to-blue-50 h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-5xl page-entering" style="height: calc(100vh - 2rem); max-height: 860px;">

        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden animate-slide-in h-full">
            <div class="grid md:grid-cols-2 h-full">
                ...
                <div class="h-full overflow-hidden">
                    <div class="form-scroll-area px-8 py-6">
                        ...
                        <form action="{{ route('register') }}" method="POST" id="registerForm" class="space-y-3.5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus @error('name') input-error @enderror"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" id="email"
                                        class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus @error('email') input-error @enderror"
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">
                                    Nomor Telepon / WhatsApp <span class="text-gray-400 text-xs font-normal">(Opsional)</span>
                                </label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        ...
                                        class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus @error('phone') input-error @enderror"
                                        placeholder="08xxxxxxxxxx"
                                        value="{{ old('phone') }}">
                                </div>
                                <p class="mt-0.5 text-xs text-gray-400">Untuk notifikasi status laundry via WhatsApp</p>
                                @error('phone') <p class="error-message">{{ $message }}</p> @enderror
                            </div>

                            {{-- LOKASI SECTION --}}
                            <div class="border border-gray-200 rounded-xl p-3.5 bg-gray-50 space-y-2.5">
                                <div class="flex items-center justify-between">
                                    <label class="block text-sm font-semibold text-gray-700">
                                        📍 Lokasi Anda <span class="text-gray-400 text-xs font-normal">(Opsional)</span>
                                    </label>
                                    <button type="button" id="btnDetectLocation"
                                        class="flex items-center gap-1.5 text-xs font-medium text-blue-600 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 border border-blue-200 px-2.5 py-1.5 rounded-lg transition-all">
                                ...
                                <p class="text-xs text-gray-500">Klik pada peta untuk menentukan lokasi, atau gunakan deteksi otomatis.</p>
                                ...
                                <div>
                                    ...
                                    <textarea name="address" id="address" rows="2"
                                        ...
                                        placeholder="Alamat akan terisi otomatis saat memilih lokasi di peta, atau isi manual...">{{ old('address') }}</textarea>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="password" id="password"
                                        class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus @error('password') input-error @enderror"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation"
                                        class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all input-focus"
                                        placeholder="Ulangi password" required>
                                </div>
                            </div>

                            <button type="submit"
                                class="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-2.5 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl btn-hover text-sm">
                                Daftar Sekarang
                            </button>
                        </form>
        ...
        document.getElementById('btnDetectLocation').addEventListener('click', function () {
            ...
            navigator.geolocation.getCurrentPosition(
                ...
                function (err) {
                    btn.disabled = false;
                    btn.innerHTML = `<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg> Deteksi Otomatis`;
                    Swal.fire({ icon: 'warning', title: 'Gagal Mendeteksi Lokasi', text: 'Izinkan akses lokasi di browser Anda, atau pilih lokasi manual di peta.', confirmButtonColor: '#2563eb' });
                },
