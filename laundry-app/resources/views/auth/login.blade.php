                    ...
                    <div class="w-full">
                        ...
                        <form action="{{ route('login') }}" method="POST" class="space-y-5" id="loginForm">
                            ...
                            <div class="animate-fade-in">   
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" id="email" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg input-focus focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('email') input-error @enderror" placeholder="email@example.com" value="{{ old('email') }}" required>
                                </div>
                                @error('email')
                            ...
                            <div class="animate-fade-in">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="password" id="password" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg input-focus focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('password') input-error @enderror" placeholder="Masukkan password" required>
                                </div>
                                @error('password')
                                    <p class="error-message">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="mt-6 text-center animate-fade-in">
                            <p class="text-sm text-gray-600">
                                Belum punya akun? 
                                <a href="{{ route('register') }}" class="text-blue-600 font-semibold hover:text-blue-700 hover:underline transition page-link">
                                    Daftar sekarang
                                </a>
                            </p>
                        </div>
