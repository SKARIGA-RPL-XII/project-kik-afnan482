...
<body class="bg-gradient-to-br from-blue-50 to-gray-100 min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-h-screen">
            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 text-white">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-2">Selamat Datang, <?php echo e(auth()->user()->name); ?>! 👋</h2>
                    ...
                    <div class="mt-4 flex items-center gap-4 text-sm">
                        <div class="flex items-center gap-2">
                            ...
                            <span><?php echo e(\Carbon\Carbon::now()->isoFormat('dddd, D MMMM Y')); ?></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                            </svg>
                            <span><?php echo e($pesananHariIni ?? 0); ?> Pesanan Hari Ini</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-blue-500 hover:shadow-md transition">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e($totalPesanan ?? 0); ?></p>
                                <p class="text-xs text-gray-500 mt-2">
                                    <span class="text-blue-600 font-semibold"><?php echo e($pesananHariIni ?? 0); ?></span> hari ini
                                </p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-500 hover:shadow-md transition">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e($pesananSelesai ?? 0); ?></p>
                                <p class="text-xs text-gray-500 mt-2">
                                    <span class="text-green-600 font-semibold"><?php echo e(($totalPesanan ?? 0) > 0 ? round((($pesananSelesai ?? 0) / $totalPesanan) * 100) : 0); ?>%</span> dari total
                                </p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-yellow-500 hover:shadow-md transition">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e(($pesananProses ?? 0) + ($pesananPending ?? 0)); ?></p>
                                <p class="text-xs text-gray-500 mt-2">
                                    <span class="text-yellow-600 font-semibold"><?php echo e($pesananPending ?? 0); ?></span> pending
                                </p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-500 hover:shadow-md transition">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-800 mt-1">Rp <?php echo e(number_format(($totalPendapatan ?? 0) / 1000000, 1)); ?>M</p>
                                <p class="text-xs text-gray-500 mt-2">
                                    Bulan ini: <span class="text-purple-600 font-semibold">Rp <?php echo e(number_format(($pendapatanBulanIni ?? 0) / 1000, 0)); ?>K</span>
                                </p>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                        ...
                        <div class="p-6">
                            <?php $__empty_1 = true; $__currentLoopData = $layananTerpopuler ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center justify-between py-3 border-b last:border-0">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-800"><?php echo e($layanan->layanan->nama_layanan ?? 'Unknown'); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($layanan->total); ?> pesanan</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <div class="w-16 bg-gray-200 rounded-full h-2">
                                        <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e(($totalPesanan ?? 0) > 0 ? ($layanan->total / $totalPesanan) * 100 : 0); ?>%"></div>
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e(($totalPesanan ?? 0) > 0 ? round(($layanan->total / $totalPesanan) * 100) : 0); ?>%</p>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between py-3 border-b last:border-0">
                                <div>
                                    <p class="font-semibold text-gray-800"><?php echo e($pesanan->invoice); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($pesanan->customer_name ?? 'Guest'); ?></p>
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e($pesanan->created_at->diffForHumans()); ?></p>
                                </div>
                                <div class="text-right">
                                    <?php
                                        $statusColors = [
                                    ...
                                    ?>
                                    <span class="px-2 py-1 rounded-full text-xs font-semibold <?php echo e($statusColors[$pesanan->status] ?? 'bg-gray-100 text-gray-800'); ?>">
                                        <?php echo e(ucfirst($pesanan->status)); ?>

                                    </span>
                                    <p class="text-xs text-gray-600 mt-1 font-semibold">Rp <?php echo e(number_format($pesanan->total, 0, ',', '.')); ?></p>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-6">
                    <a href="<?php echo e(route('admin.pesanan.index')); ?>" class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition group">
                    ...
                    <a href="<?php echo e(route('admin.pelanggan.index')); ?>" class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition group sm:col-span-2 lg:col-span-1">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-sm text-gray-600"><?php echo e($totalPelanggan ?? 0); ?> terdaftar</p>
                            </div>
                        </div>
                    </a>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pesananData = <?php echo json_encode($pesananData ?? []); ?>;
            const pendapatanData = <?php echo json_encode($pendapatanData ?? []); ?>;
...
</html><?php /**PATH C:\laragon\www\project-kik-afnan482\laundry-app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>